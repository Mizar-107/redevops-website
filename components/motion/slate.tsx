...
import { reelLabel, section, type SectionId } from "@/lib/sections"
...
export type SlateProps = {
  ...
  align?: "start" | "center"
  trigger?: "view" | "intro"
  /** override the scrambled label (default "REEL 02 · SERVICES") */
  label?: string
...
/**
 * Film slate eyebrow: mono REEL label (scrambles in), a dim cut name at md+, and a hairline rule
